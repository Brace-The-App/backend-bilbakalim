...
class Duel extends Model
{
    protected $fillable = [
        ...
        'current_question_id',
        'challenger_diamonds_before',
        'opponent_diamonds_before',
        'challenger_diamonds_after',
        'opponent_diamonds_after',
        'app_commission',
        'winner_id',
        'started_at',
        'finished_at',
    ...
    protected $casts = [
        ...
        'challenger_diamonds_before' => 'integer',
        'opponent_diamonds_before' => 'integer',
        'challenger_diamonds_after' => 'integer',
        'opponent_diamonds_after' => 'integer',
